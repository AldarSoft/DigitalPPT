...
export const adminOrganizationListFixture: AdminOrganizationLicenseListResponse = {
  ...
  previous: null,
  results: [
    { id: 1, name: 'Digital PTT Aldarsoft', owner: { name: 'Client Local', email: 'client@digitalptt.local' }, license_count: 2, used_capacity: 250, total_capacity: 400, next_expiry: '2027-08-17', status: 'expiring_soon' },
    { id: 2, name: 'Global Radio Solutions', owner: { name: 'S. Bat', email: 'sales@globalradio.com' }, license_count: 4, used_capacity: 430, total_capacity: 800, next_expiry: '2027-12-03', status: 'active' },
    { id: 3, name: 'Nomad Logistics', owner: { name: 'A. Enkh', email: 'admin@nomadlogistics.mn' }, license_count: 1, used_capacity: 50, total_capacity: 200, next_expiry: '2027-07-01', status: 'pending_payment' },
    { id: 4, name: 'Mongolian Mining Corp', owner: { name: 'J. Tseren', email: 'it@mmc.mn' }, license_count: 3, used_capacity: 516, total_capacity: 600, next_expiry: '2028-02-12', status: 'active' },
  ],
}
...
export const adminOrganizationDetailFixture: AdminOrganizationLicenseDetail = {
  ...
  summary: { subscription_starts_on: '2026-08-18', subscription_expires_on: '2027-08-17', licensed_product_count: 4, active_quantity: 63, status: 'expiring_soon' },
